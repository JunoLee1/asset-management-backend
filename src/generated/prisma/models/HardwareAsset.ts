...
// @ts-nocheck 
/*
 * This file exports the `HardwareAsset` model and its related types.
 *
...
export type GetHardwareAssetAggregateType<T extends HardwareAssetAggregateArgs> = {
      [P in keyof T & keyof AggregateHardwareAsset]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateHardwareAsset[P]>
    : Prisma.GetScalarType<T[P], AggregateHardwareAsset[P]>
}
...
export type GetHardwareAssetGroupByPayload<T extends HardwareAssetGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<HardwareAssetGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof HardwareAssetGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], HardwareAssetGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], HardwareAssetGroupByOutputType[P]>
      }
    >
  >
...
export type HardwareAssetCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<HardwareAssetFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface HardwareAssetDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['HardwareAsset'], meta: { name: 'HardwareAsset' } }
  /**
   ...
   * })
  **/
  count<T extends HardwareAssetCountArgs>(
    args?: Prisma.Subset<T, HardwareAssetCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], HardwareAssetCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends HardwareAssetGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, HardwareAssetGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetHardwareAssetGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
