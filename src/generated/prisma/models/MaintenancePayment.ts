...
// @ts-nocheck 
/*
 * This file exports the `MaintenancePayment` model and its related types.
 *
...
export type GetMaintenancePaymentAggregateType<T extends MaintenancePaymentAggregateArgs> = {
      [P in keyof T & keyof AggregateMaintenancePayment]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateMaintenancePayment[P]>
    : Prisma.GetScalarType<T[P], AggregateMaintenancePayment[P]>
}
...
export type GetMaintenancePaymentGroupByPayload<T extends MaintenancePaymentGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<MaintenancePaymentGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof MaintenancePaymentGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], MaintenancePaymentGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], MaintenancePaymentGroupByOutputType[P]>
      }
    >
  >
...
export type MaintenancePaymentCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<MaintenancePaymentFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface MaintenancePaymentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['MaintenancePayment'], meta: { name: 'MaintenancePayment' } }
  /**
   ...
   * })
  **/
  count<T extends MaintenancePaymentCountArgs>(
    args?: Prisma.Subset<T, MaintenancePaymentCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], MaintenancePaymentCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends MaintenancePaymentGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, MaintenancePaymentGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMaintenancePaymentGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
