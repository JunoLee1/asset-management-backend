...
export type RefreshTokenOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "tokenHash" | "userAgent" | "ipAddress" | "revokedAt" | "expiresAt" | "createdAt" | "userId", ExtArgs["result"]["refreshToken"]>;
