...
| 보안 — 초대 남용 방지 (탈취된 ADMIN 계정 시나리오) | ✅ Rate Limit 1시간/10회, 재초대 시 "이미 초대 발송된 이메일" 차단, USER_INVITE sensitiveAudit 로그 기록 |
...
| 탈취 계정 남용 — 소프트웨어 대량 등록 | ✅ 5분/20회 Rate Limit 적용 |
| 탈취 계정 남용 — 카탈로그 대량 등록/수정 | ✅ 5분/20회 Rate Limit 적용 |
| 탈취 계정 남용 — 부서/팀/위치/카테고리 대량 등록 | ✅ 5분/20회 Rate Limit 적용 |
