...
// @ts-nocheck 
/*
 * This file exports the `FacilityAsset` model and its related types.
 *
...
export type GetFacilityAssetAggregateType<T extends FacilityAssetAggregateArgs> = {
      [P in keyof T & keyof AggregateFacilityAsset]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateFacilityAsset[P]>
    : Prisma.GetScalarType<T[P], AggregateFacilityAsset[P]>
}
...
export type GetFacilityAssetGroupByPayload<T extends FacilityAssetGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<FacilityAssetGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof FacilityAssetGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], FacilityAssetGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], FacilityAssetGroupByOutputType[P]>
      }
    >
  >
...
export type FacilityAssetCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<FacilityAssetFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface FacilityAssetDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['FacilityAsset'], meta: { name: 'FacilityAsset' } }
  /**
   ...
   * })
  **/
  count<T extends FacilityAssetCountArgs>(
    args?: Prisma.Subset<T, FacilityAssetCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], FacilityAssetCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends FacilityAssetGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, FacilityAssetGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetFacilityAssetGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
