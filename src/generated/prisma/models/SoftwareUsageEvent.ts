...
// @ts-nocheck 
/*
 * This file exports the `SoftwareUsageEvent` model and its related types.
 *
...
export type GetSoftwareUsageEventAggregateType<T extends SoftwareUsageEventAggregateArgs> = {
      [P in keyof T & keyof AggregateSoftwareUsageEvent]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateSoftwareUsageEvent[P]>
    : Prisma.GetScalarType<T[P], AggregateSoftwareUsageEvent[P]>
}
...
export type GetSoftwareUsageEventGroupByPayload<T extends SoftwareUsageEventGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<SoftwareUsageEventGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof SoftwareUsageEventGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], SoftwareUsageEventGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], SoftwareUsageEventGroupByOutputType[P]>
      }
    >
  >
...
export type SoftwareUsageEventCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<SoftwareUsageEventFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface SoftwareUsageEventDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['SoftwareUsageEvent'], meta: { name: 'SoftwareUsageEvent' } }
  /**
   ...
   * })
  **/
  count<T extends SoftwareUsageEventCountArgs>(
    args?: Prisma.Subset<T, SoftwareUsageEventCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], SoftwareUsageEventCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends SoftwareUsageEventGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, SoftwareUsageEventGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSoftwareUsageEventGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
