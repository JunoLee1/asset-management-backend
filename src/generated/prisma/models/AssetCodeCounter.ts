...
// @ts-nocheck 
/*
 * This file exports the `AssetCodeCounter` model and its related types.
 *
...
export type GetAssetCodeCounterAggregateType<T extends AssetCodeCounterAggregateArgs> = {
      [P in keyof T & keyof AggregateAssetCodeCounter]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateAssetCodeCounter[P]>
    : Prisma.GetScalarType<T[P], AggregateAssetCodeCounter[P]>
}
...
export type GetAssetCodeCounterGroupByPayload<T extends AssetCodeCounterGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<AssetCodeCounterGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof AssetCodeCounterGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], AssetCodeCounterGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], AssetCodeCounterGroupByOutputType[P]>
      }
    >
  >
...
export type AssetCodeCounterCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<AssetCodeCounterFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface AssetCodeCounterDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['AssetCodeCounter'], meta: { name: 'AssetCodeCounter' } }
  /**
   ...
   * })
  **/
  count<T extends AssetCodeCounterCountArgs>(
    args?: Prisma.Subset<T, AssetCodeCounterCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], AssetCodeCounterCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends AssetCodeCounterGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, AssetCodeCounterGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAssetCodeCounterGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
