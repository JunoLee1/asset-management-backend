...
// @ts-nocheck 
/*
 * This file exports the `OfficeAsset` model and its related types.
 *
...
export type GetOfficeAssetAggregateType<T extends OfficeAssetAggregateArgs> = {
      [P in keyof T & keyof AggregateOfficeAsset]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateOfficeAsset[P]>
    : Prisma.GetScalarType<T[P], AggregateOfficeAsset[P]>
}
...
export type GetOfficeAssetGroupByPayload<T extends OfficeAssetGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<OfficeAssetGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof OfficeAssetGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], OfficeAssetGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], OfficeAssetGroupByOutputType[P]>
      }
    >
  >
...
export type OfficeAssetCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<OfficeAssetFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface OfficeAssetDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['OfficeAsset'], meta: { name: 'OfficeAsset' } }
  /**
   ...
   * })
  **/
  count<T extends OfficeAssetCountArgs>(
    args?: Prisma.Subset<T, OfficeAssetCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], OfficeAssetCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends OfficeAssetGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, OfficeAssetGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetOfficeAssetGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
